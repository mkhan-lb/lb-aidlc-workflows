...
| --- | --- | --- |
| `service-workflows-backend` | 12 | One service uses established domain and platform patterns |
| `service-workflows-backend-design` | 15 | New business rules, data models, or NFR decisions need dedicated design |
...
Invoke `/aidlc --scope service-workflows-backend` (`$aidlc --scope
service-workflows-backend` on Codex). The default is unchanged; select this profile
